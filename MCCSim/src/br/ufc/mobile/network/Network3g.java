...
public class Network3g extends Bandwidth {
	public Network3g(String label) {
		this();
		this.name = label;
	}

	public Network3g() {
		this("3g_transfer_up_info.txt", "3g_transfer_down_info.txt");
	}

	public Network3g(String dataFileUp, String dataFileDown) {
