...
public class NetworkWifi extends Bandwidth {

	public NetworkWifi() {
		this("wifi_transfer_up_info.txt", "wifi_transfer_down_info.txt");
	}

	public NetworkWifi(String dataFileUp,String dataFileDown) {
