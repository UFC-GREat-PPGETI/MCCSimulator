...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        mobileCloudlet.setOffloadStatus(OffloadStatus.STATIC);
        ...
        //Offloader offloader = new DefaultOffloader();
        ...
        CloudHardwareConfigurator.setExecutionTimeRelationBetweenCloudHardWareDeviceHardware(mobileCloudlet, 100, 10, cloudHardware, deviceHardware);
